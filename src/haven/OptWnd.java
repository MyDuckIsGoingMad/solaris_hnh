...
public class OptWnd extends Window {
	...
	public static final RichText.Foundry foundry11 = new RichText.Foundry(TextAttribute.FAMILY, "SansSerif",
			TextAttribute.SIZE, 11);
	public static final RichText.Foundry foundry12 = new RichText.Foundry(TextAttribute.FAMILY, "SansSerif",
			TextAttribute.SIZE, 12);
	public static final RichText.Foundry foundry13 = new RichText.Foundry(TextAttribute.FAMILY, "SansSerif",
			TextAttribute.SIZE, 13);
	public static final RichText.Foundry foundry14 = new RichText.Foundry(TextAttribute.FAMILY, "SansSerif",
	...
	public OptWnd(Coord c, Widget parent) {
		...
		{ /* CAMERA TAB */
			...
			new Label(new Coord(10, 360), tab,
					"WARNING: Disabling camera borders can cause issues when entering a house or cave.");
		...
		{ /* AUDIO TAB */
			...
			final Label musicvol = new Label(new Coord(235, 69 + (int) (Config.musicVol * 1.86)), tab,
					String.valueOf(100 - getsfxvol()) + " %");
		...
		{ /* CUSTOM TAB */
			...
			final RichTextBox uiinfo = new RichTextBox(new Coord(140, 65), new Coord(200, 160), tab,
					"Use the sliders on the left to change the UI color / transparency. These changes will automatically save.",
					foundry12);
			uiinfo.bg = new java.awt.Color(0, 0, 0, 64);

			(new Scrollbar(new Coord(25, 70), 150, tab, 0, 255) {
				{
					val = max - Config.uiColor.getRed();
				}
			...
			(new Scrollbar(new Coord(50, 70), 150, tab, 0, 255) {
				{
					val = max - Config.uiColor.getGreen();
				}
			...
			(new Scrollbar(new Coord(75, 70), 150, tab, 0, 255) {
				{
					val = max - Config.uiColor.getBlue();
				}
			...
			(new Scrollbar(new Coord(100, 70), 150, tab, 0, 255) {
				{
					val = max - Config.uiColor.getAlpha();
				}
			...
			final RichTextBox hdinfo = new RichTextBox(new Coord(140, 295), new Coord(200, 160), tab,
					"Use the sliders on the left to change the color of the hidden object bound boxes. These changes will automatically save. ",
					foundry12);
			hdinfo.bg = new java.awt.Color(0, 0, 0, 64);

			(new Scrollbar(new Coord(25, 300), 150, tab, 0, 255) {
				{
			...
			(new Scrollbar(new Coord(50, 300), 150, tab, 0, 255) {
				{
			...
			(new Scrollbar(new Coord(75, 300), 150, tab, 0, 255) {
				{
			...
			(new Scrollbar(new Coord(100, 300), 150, tab, 0, 255) {
				{
		...
		{ /* INFO TAB */
			...
			final RichTextBox helpinfo2 = new RichTextBox(new Coord(5, 90), new Coord(400, 160), tab,
					"To update the client, simply download the latest files from the Legacy H&H discord and place it into the folder containing the client files. This will overwrite the old  files and update the client.",
					foundry14);
			helpinfo2.bg = new java.awt.Color(0, 0, 0, 0);
			final RichTextBox helpinfo3 = new RichTextBox(new Coord(5, 210), new Coord(400, 160), tab,
					"(this client is a fork from the original Union Client source)", foundry12);
